...
RSpec.describe "Sign in using username", type: :request do
  describe 'POST /authentications/signin_username' do
    context 'When given complete fields as company' do
      before(:each) do
        ...
        signin_params = { user: {username: 'swiftymarks', password: '1234567890'} }.to_json
    ...
    context 'When invalid credentials' do
      before(:each) do        
        signin_params = { user: {username: 'dwde', password: '1234567890'} }.to_json
        post "http://localhost:3000/api/v1/authentications/signin_username", params: signin_params, headers: { 'Content-Type' => 'application/json' }
      end

...
RSpec.describe "Create new project", type: :request do
  describe 'POST /projects' do
    context 'Create new project completed' do
      ...
      it "should have a record in database" do
        json = JSON.parse(response.body)
        id = json["project"]["id"]
    ...
    context 'Fetching platforms with invalid Bearer' do
      before(:each) do
        ...
        post "http://localhost:3000/api/v1/projects/create", params: create_project_params, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer XXXXXX' }              
      end

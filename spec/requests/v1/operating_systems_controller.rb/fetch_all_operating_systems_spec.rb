...
RSpec.describe "Fetch Operating Systems", type: :request do
  describe 'GET /operating_systems' do
    context 'Fetching Operating system completed' do
      before(:each) do
        ...
        get "http://localhost:3000/api/v1/operating_systems", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer ' + access_key }        
      end
      ...
      it "should respond with body of" do
        ...
        expect(json["operating_systems"]).not_to be_nil
      end
    end

    context 'Fetching operating systems with invalid Bearer' do
      before(:each) do
        ...
        get "http://localhost:3000/api/v1/operating_systems", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer XXXXXXX' }        
      end

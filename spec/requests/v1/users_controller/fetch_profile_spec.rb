...
RSpec.describe "Fetch My Profile", type: :request do
  describe 'GET /users/profile' do
    context 'Fetching with valid Bearer Token as Tester' do
      before(:each) do
        ...
        get "http://localhost:3000/api/v1/users/profile", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer ' + access_key }        
      end
    ...
    context 'Fetching with valid Bearer Token as Company' do
      before(:each) do
    ...
    context 'Fetching with invalid Bearer Token as any user' do
      before(:each) do
        signup_params = { user: { first_name: 'Mark Kevin', last_name: 'King', email:'king.mark.kevin@icloud.com', username: 'swiftymarks', password: '1234567890'}}.to_json 
        post "http://localhost:3000/api/v1/authentications/signup_as_tester", params: signup_params, headers: { 'Content-Type' => 'application/json' }
        access_key = JSON.parse(response.body)["access_key"]
        ...
        get "http://localhost:3000/api/v1/users/profile", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer XXXXXXX' }        
      end

...
RSpec.describe "Fetch All Brands", type: :request do
  describe 'GET /brands' do
    context 'Fetching All Brands completed' do
      before(:each) do
        ...
        get "http://localhost:3000/api/v1/platforms", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer ' + access_key }        
      end
      ...
      it "should respond with body of" do
        ...
        expect(json["platforms"]).not_to be_nil
      end
    end

    context 'Fetching all brands with invalid Bearer' do
      before(:each) do
        ...
        get "http://localhost:3000/api/v1/platforms", params: nil, headers: { 'Content-Type' => 'application/json', 'Authorization' => 'Bearer XXXXXXX' }        
      end
